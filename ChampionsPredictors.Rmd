...
#head(noDraws$homeWin, 10)
noDraws$output = factor(noDraws$homeWin, labels=c("Away Win", "Home Win"))
#head(noDraws$output, 10)

#names(Match)
#names(Team_Attributes)
#head(Team_Attributes$chanceCreationShooting, 10)
#head(Team_Attributes$defencePressure, 10)
#head(Match$away_team_api_id, 10)
#head(Match$home_team_api_id,10)
